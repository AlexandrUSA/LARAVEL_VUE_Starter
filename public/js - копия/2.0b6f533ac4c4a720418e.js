  ...
  data: function data() {
    return {
      ...
      emailRules: [function (v) {
        return !!v || _this.invalidInput;
      }],
      invalidInput: _this.$t('required_value'),
