            ...
            directives: [
              {
                name: "show",
                rawName: "v-show",
                value: _vm.state == "register",
                expression: "state == 'register'"
              }
            ]
          })
        ],
